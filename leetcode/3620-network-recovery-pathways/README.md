...
**Problem:** [Network-Recovery-Pathways](https://leetcode.com/problems/network-recovery-pathways)
...
Example 1:**Input:** edges = [[0,1,5],[1,3,10],[0,2,3],[2,3,4]], online = [true,true,true,true], k = 10
